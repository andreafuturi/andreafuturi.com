...
function Atom({ width, atoms, fill, x, y, cx, cy, filled, spacing = 1, ...props } = {}, ...children) {
  ...
  const logoPoints = new SVGPathCommander(
    `M${logoX} ${logoY}h-347.6l-456.2 -627.8l-135.6 186.5l320.6 441.3h-347.6l-146.8 -202l-146.8 202h-347.6l803.8 -${logoHeight}l803.8 ${logoHeight}zm-331.9 -30.9h271.1l-743 -1022.8l-743.1 1022.8h271.1l162.6 -223.7l162.6 223.7h271.1l-298.1 -410.4l173.8 -239.2l471.9 649.6z`,
  );
  const logoPointsfilled = new SVGPathCommander(
    `M${4944 / 2 + (x || 0)},${8776 / 2 + (y || 0)}l1547,2128h3094l-3094,-4258l1547,-2128l4641,6387h3094l-7735,-10646l-7734,10645h3094l1546,-2128z`,
  );
